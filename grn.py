...
# Applying model
#CLASS = np.zeros(n)
CLASS = ["Unknown" for x in range(n)]
for i in range(0,n):
    if df6.iloc[i, 0] == 'A' or df6.iloc[i, 0] == 'B': CLASS[i]='Regulator'
    if df6.iloc[i, 0] == 'D' or df6.iloc[i, 0] == 'E' or df6.iloc[i, 0] == 'F': CLASS[i]='Target'
    if df6.iloc[i, 0] == 'C':
	    if df6.iloc[i, 1] == 'D' or df6.iloc[i, 1] == 'E' or df6.iloc[i, 1] == 'F': CLASS[i]='Regulator'
    if df6.iloc[i, 0] == 'C':
        if df6.iloc[i, 1] == 'A' or df6.iloc[i, 1] == 'B': CLASS[i]='Unknown'
    if df6.iloc[i, 0] == 'C':
        if df6.iloc[i, 1] == 'C':
            if df6.iloc[i, 2] == 'D' or df6.iloc[i, 2] == 'E' or df6.iloc[i, 2] == 'F': CLASS[i]='Regulator'
    if df6.iloc[i, 0] == 'C':
        if df6.iloc[i, 1] == 'C':
            if df6.iloc[i, 2] == 'C': CLASS[i]='Target'
    if df6.iloc[i, 0] == 'C':
        if df6.iloc[i, 1] == 'C':
            if df6.iloc[i, 2] == 'A' or df6.iloc[i, 2] == 'B': CLASS[i]='Unknown'
...
df7.to_excel('04_final_classification.xlsx')
