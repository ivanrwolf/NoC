...
# Run discretizer
echo "Calculating topologies and discretinzing"
wait
...
wait
java -Xmx15200M -cp ../00_data/weka-3-8-5/weka.jar weka.classifiers.meta.Vote -l ${path_weka_model} -p 0 -T ${path_weka_input} | grep -v '^$' |sed '1d' | sed -e 's/1\://g' -e 's/2\://g' -e 's/[space]*/\t/'| awk '{OFS="\t"}{print $1,$2,$3,$4,$5,$6}' > ${path_test_predictions}.temp
wait
